...
def net_salary(gross_annual):
    '''Method to compute the monthly and annual salary of employee

    Args:
        gross_annual (float): Total gross annual salary of employee.
    '''
    ...
    return 'Monthly and yearly salary of {} {} is NGN{} and NGN{} respectively.'.format(first_name, last_name, round(monthly_net,2), round(yearly_net,2))
